...
const JSON_FILE_NAME = 'translates/meetings.json'; // Название JSON файла (должен быть в корне проекта)
const CATEGORY_ID = 16; // ID категории, в которую будут импортированы фразы
// ============================================
